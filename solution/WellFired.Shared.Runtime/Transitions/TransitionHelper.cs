		...
		private static MethodInfo GetMainGameView
		{
			get
			{
				if(getMainGameView == null)
					getMainGameView = PlatformSpecificFactory.ReflectionHelper.GetNonPublicStaticMethod(GameViewType, "GetMainGameView");
		...
		private static MethodInfo RepaintAllMethod
		{
			get
			{
				if(repaintAllMethod == null)
					repaintAllMethod = PlatformSpecificFactory.ReflectionHelper.GetMethod(GameViewType, "Repaint");
		...
		private static PropertyInfo GameViewRenderRect
		{
			get
			{
				if(gameViewRenderRect == null)
					gameViewRenderRect = PlatformSpecificFactory.ReflectionHelper.GetNonPublicInstanceProperty(GameViewType, "gameViewRenderRect");
		...
		private static FieldInfo ShownResolution
		{
			get
			{
				if(shownResolution == null)
					shownResolution = PlatformSpecificFactory.ReflectionHelper.GetNonPublicInstanceField(GameViewType, "m_ShownResolution");
