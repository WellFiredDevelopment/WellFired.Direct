...
namespace WellFired
{
	...
	public interface ISelectableContainer
	{
		...
		void OnSelectedObjects(List<Object> selectedObjects);
		...
		/// </summary>
		/// <param name="selectedObjects">Selected objects.</param>
		void OnDeSelectedObjects(List<Object> selectedObjects);
		...
		List<Object> GetSelectableObjectUnderPos(Vector2 mousePosition);
		...
		List<Object> GetSelectableObjectsUnderRect(Rect selectionRect, float yScroll);
