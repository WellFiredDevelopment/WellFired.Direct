...
namespace WellFired
{
	...
	{
		[SerializeField]
		private Shared.Easing.EasingType easingType = Shared.Easing.EasingType.Linear;
		public Shared.Easing.EasingType EasingType
		{
		...
		[SerializeField]
		private Shared.ShakeType shakeType = Shared.ShakeType.None;
		public Shared.ShakeType ShakeType
		{
