...
namespace WellFired
{
	...
	public class USLookAtObjectEvent : USEventBase
	{
	    ...
	    public override void ProcessEvent(float deltaTime)
	    {
			...
			var inDuration = inCurve[inCurve.length-1].time;
			var holdDuration = lookAtTime + inDuration;
			...
			var sourcePosition = AffectedObject.transform.position;
			var destinationPosition = objectToLookAt.transform.position;
			var toTarget = destinationPosition - sourcePosition;
			var targetOrientation = Quaternion.LookRotation(toTarget);
